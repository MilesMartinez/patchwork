...
export const galleries: Gallery[] = [
  ...
  },
  {
    ...
    imageUrl: '/images/carpentry/carpentry1_after.jpg',
    slug: 'carpentry',
    images: [
      {
        id: 1,
        title: 'Custom Closet Installation',
        beforeImage: '/images/carpentry/carpentry1_before.jpg',
        afterImage: '/images/carpentry/carpentry1_after.jpg',
        description: 'Installation of custom closet',
      },
      {
        id: 2,
        title: 'Window Frame Repair',
        beforeImage: '/images/carpentry/carpentry2_before.jpg',
        afterImage: '/images/carpentry/carpentry2_after.jpg',
        description: 'Professional window frame repair and restoration',
      },
      {
        id: 3,
        title: 'Custom Finishing on Wood',
        beforeImage: '/images/carpentry/carpentry3_before.jpg',
        afterImage: '/images/carpentry/carpentry3_after.jpg',
        description: 'Custom finishing on wood',
      },
      {
        id: 4,
        title: 'Custom Storage Installation',
        beforeImage: '/images/carpentry/carpentry4_before.jfif',
        afterImage: '/images/carpentry/carpentry4_after.jpeg',
        description: 'Custom installation of bathroom storage',
      },
      {
        id: 5,
        title: 'Closet Door Installation',
        beforeImage: '/images/carpentry/carpentry5_before.jpg',
        afterImage: '/images/carpentry/carpentry5_after.jpg',
        description: 'Expert installation of closet doors',
      },
      {
        id: 6,
        title: 'Baseboard Repair',
        beforeImage: '/images/carpentry/carpentry6_before.jpg',
        afterImage: '/images/carpentry/carpentry6_after.jpg',
        description: 'Baseboard repair and restoration',
      },
      {
        id: 7,
        title: 'Cabinet Repair',
        beforeImage: '/images/carpentry/carpentry7_before.jpg',
        afterImage: '/images/carpentry/carpentry7_after.jpg',
        description: 'Cabinet repair and restoration of sink cabinet',
      },
      {
        id: 8,
        title: 'Wainscoting',
        beforeImage: '/images/carpentry/carpentry8_before.jpg',
        afterImage: '/images/carpentry/carpentry8_after.jpg',
        description: 'Professional raised panel wainscoting addition',
      },
      {
        id: 9,
        title: 'Decorative Trim',
        beforeImage: '/images/carpentry/carpentry9_before.jpg',
        afterImage: '/images/carpentry/carpentry9_after.jpg',
        description: 'Expert decorative ceiling trim installation',
      },
      {
        id: 10,
        title: 'Baseboard Repair',
        beforeImage: '/images/carpentry/carpentry10_before.jpg',
        afterImage: '/images/carpentry/carpentry10_after.jpg',
        description: 'Baseboard repair and restoration',
      },
      {
        id: 11,
        title: 'Attic Door Restoration',
        beforeImage: '/images/carpentry/carpentry11_before.jpg',
        afterImage: '/images/carpentry/carpentry11_after.jpg',
